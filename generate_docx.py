...
def generate_doc(params_list: list, correct_permutation_params: list, name: str) -> None:
    ...
    harr4_run.bold = True
    harr4_paragraph.alignment = WD_PARAGRAPH_ALIGNMENT.LEFT
    ...
    harrgr_run.alignment = WD_PARAGRAPH_ALIGNMENT.LEFT
    ...
    dl_run = dl_paragraph.add_run('Продольное смещение грузов в вагоне: ' + str(correct_permutation_params[0]) + 'мм\n')
    dl_run = dl_paragraph.add_run('Продольное смещение грузов с вагоном: ' + str(correct_permutation_params[1]) + 'мм')
    ...
    h_run = h_paragraph.add_run('Высота ЦТ грузов в вагоне: ' + str(correct_permutation_params[2]) + 'мм\n')
    h_run = h_paragraph.add_run('Общая высота ЦТ: ' + str(correct_permutation_params[3]) + 'мм\n')
    h_run = h_paragraph.add_run('Расчет наветренной поверхности: ' + str(correct_permutation_params[4]) + 'м ^ 2')

    sili_paragraph = doc.add_paragraph()
    sili_run = sili_paragraph.add_run('3. Расчет сил и устойчивости')
    sili_run.bold = True
    ...
    for i in range(m):
        ...
        mn_run1 = mn_r1.add_run('Продольная инерционная сила: ' + str(correct_permutation_params[5][i][0]) + 'тс\n')
        mn_run1 = mn_r1.add_run('Поперечная инерционная сила: ' + str(correct_permutation_params[5][i][1]) + 'тс\n')
        mn_run1 = mn_r1.add_run('Вертикальная инерционная сила: ' + str(correct_permutation_params[5][i][2]) + 'тс\n')
        mn_run1 = mn_r1.add_run('Ветровая нагрузка: ' + str(correct_permutation_params[5][i][3]) + 'тс\n')
        mn_run1 = mn_r1.add_run('Сила трения в продольном направлении: ' + str(correct_permutation_params[5][i][4]) + 'тс\n')
        mn_run1 = mn_r1.add_run('Сила трения в поперечном направлении: ' + str(correct_permutation_params[5][i][5]) + 'тс\n')
        mn_run1 = mn_r1.add_run('Усилия которые должны восприниматься средствами крепления\n')
        mn_run1 = mn_r1.add_run('Продольное: ' + str(correct_permutation_params[5][i][6]) + 'тс\n')
        mn_run1 = mn_r1.add_run('Поперечное: ' + str(correct_permutation_params[5][i][7]) + 'тс\n')
